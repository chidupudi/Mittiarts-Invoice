// api/send-completion-sms.js - Vercel API endpoint for payment completion SMS
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (!phoneNumber || !customerName || !orderNumber || !finalAmount || !billToken) {
...
- Mitti Arts Team`;
    ...
    console.error('❌ Completion SMS Error:', error.response?.data || error.message);
